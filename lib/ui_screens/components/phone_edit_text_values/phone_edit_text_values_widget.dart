...
import 'phone_edit_text_values_model.dart';
export 'phone_edit_text_values_model.dart';
...
class _PhoneEditTextValuesWidgetState extends State<PhoneEditTextValuesWidget> {
  late PhoneEditTextValuesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PhoneEditTextValuesModel());
