...
class _OffersDetailsPageWidgetState extends State<OffersDetailsPageWidget>
    with TickerProviderStateMixin {
  late OffersDetailsPageModel _model;
                                                ...
                                                children: [
                                                  Builder(
                                                    builder: (context) =>
                                                      ...
                                                      onTap: () async {
                                                        await Share.share(
                                                          'https://usamaDevHynda.com${GoRouter.of(context).location}',
                                                          sharePositionOrigin:
